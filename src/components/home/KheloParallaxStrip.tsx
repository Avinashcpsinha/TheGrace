...
/**
 * KheloParallaxStrip — full-bleed auto-drifting strip of Khelo India award
 * photos. Two motions compose: a slow seamless marquee drift (GSAP, looping
...
export interface KheloStripImage {
  src: string;
  blur: string;
  alt: string;
}

export function KheloParallaxStrip({ images }: { images: KheloStripImage[] }) {
  ...
  if (reduced) {
    return (
      <div
        role="region"
        aria-label="Official Khelo India award pieces"
        tabIndex={0}
